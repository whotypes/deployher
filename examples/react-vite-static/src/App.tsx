  ...
  return (
    <div className="app" onKeyDown={handleKeyDown} role="presentation" tabIndex={0}>
      <header className="header">
        <h1>react-vite-static</h1>
        <p>
          Vite + React built to <code>dist/</code> for Deployher static hosting. Local dev uses port{" "}
          <strong>5173</strong>; <code>vite preview</code> uses <code>PORT</code> when set (see{" "}
          <code>vite.config.ts</code>). <code>package.json</code> <code>deployher.serveStrategy: static</code> pins
          output so Auto-detect serves <code>dist/index.html</code>.
        </p>
      </header>
