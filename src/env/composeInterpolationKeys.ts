...
export const COMPOSE_INTERPOLATION_KEYS = [
  "BUILD_WORKERS",
  "DEPLOYHER_API_HOSTNAME",
  "DEPLOYHER_DASH_HOSTNAME",
  "DEPLOYHER_EDGE_USE_PATH_ROUTING",
  "DEPLOYHER_LANDING_HOSTNAME",
  "DEPLOYHER_LANDING_HOSTNAMES",
  "DEPLOYHER_PRIMARY_DOMAIN",
  "NEXUS_REGISTRY",
